...
<div>
  <h3 align="left">Languages and Tools:</h3>
    <a href="https://github.com/devmuhammadzaki">
        <p align="center">
            <img
                src="https://go-skill-icons.vercel.app/api/icons?i=html,css,js,jquery,bootstrap,tailwind,vue,php,laravel,codeigniter,yii,symfony,cake,mysql,mariadb,sqlite,redis,rabbitmq,git,linux,docker,aws&perline=14"
                alt="Skills"
            />
        </p>
    </a>
